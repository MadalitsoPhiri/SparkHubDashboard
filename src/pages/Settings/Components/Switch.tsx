  ...
  return (
    <Switch
      ...
      className={classNames(
        'relative inline-flex bg-gray-400 p-1 flex-shrink-0 2xl:h-[28px] 2xl:w-14  xl:w-12 xl:h-[24px] rounded-[4px] border-transparent  cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none ',
      )}
    >
