...
const InputPrompt: FC<any> = ({ title, currentIndex, lastIndex, msg }) => {
  const [inputValue, setInputValue] = useState('');

  const handleSubmitPrompt = () => null;
    ...
    >
      <div className='w-full mb-[8px] flex flex-row overflow-x-hidden items-end justify-end'>
        ...
        <div className='flex flex-col flex-1 max-w-[85%]'>
          <div className='rounded-[6px] border-btnColor flex-1 border-t-2  shadow-lg bg-white   mb-[6px]'>
            <div className='border border-t-none rounded-[6px] flex flex-col px-[24px] py-[26px] w-full '>
              ...
              <div className='flex flex-row  h-[40px] border border-gray-300 rounded-[4px]'>
                <input
                  ...
                  value={msg.status === 'sent' ? msg.text : inputValue}
                ...
                {msg.status != 'sent' ? (
                  <div
                    ...
                    className='bg-btnColor w-[40px] h-full rounded-r-[4px] flex justify-center items-center cursor-pointer flex-shrink-0'
                  >
                    {msg.status === 'waiting' ? (
                      <svg
                  ...
                  <div className=' bg-gray-50 w-[40px] h-full rounded-r-[4px] flex justify-center items-center cursor-pointer flex-shrink-0'>
                    <svg
...
export default observer(InputPrompt);
